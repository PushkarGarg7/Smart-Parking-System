...
# Process detected objects and count cars in each area
# ...
...
for index, row in px.iterrows():
    ...
    if 'car' in c:
        ...
        if results12>= 0:
            ...
            list1.append(c)
            cv2.putText(frame, str(c), (x1, y1), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)    
        # (Repeat similar code for other areas)

# Count the number of cars in each area
a1 = len(list1)
a2 = len(list2)
a3 = len(list3)
a4 = len(list4)
...
# processed_image_path='/public/processed_image.jpg'
# cv2.imwrite(processed_image_path,processed_image)

# with open(processed_image_path,'rb') as image_file:
#     encoded_image=base64.b64encode(image_flie.read()).decode('utf-8')
#     print(encoded_image)
